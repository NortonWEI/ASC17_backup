...
#include <omp.h>
// If this routine is compiled with HPCG_NO_MPI and not compiled with HPCG_NO_OPENMP then use OpenMP timer
double mytimer(void) {
...
#else // !HPCG_OFFLOAD
#ifndef _OPENMP
#error "Offload versions need to be compiled with OpenMP support Xeon Phi!"
#endif
